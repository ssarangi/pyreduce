...
from .system_info_gatherer import system_info_gatherer, memory_info_gatherer, process_info_gatherer
...
def send_heartbeat(agent_info):
    while True:
        ...
        pid_count, percent_mem_used = process_info_gatherer(), memory_info_gatherer()
        heartbeat_request = master_pb2.AgentHeartBeatRequest(
            unique_id=agent_info.unique_id,
            pid_count = pid_count,
            percent_memory_used=percent_mem_used)
